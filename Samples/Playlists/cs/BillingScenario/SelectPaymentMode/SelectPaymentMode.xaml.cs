...
namespace SDKTemplate.BillingScenario.SelectPaymentMode
{
    /// <summary>
    ...
    public sealed partial class SelectPaymentMode : Page
    {
        ...
        private void ProceedToPayment_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (CashRadBtn.IsChecked == true)
                this.Frame.Navigate(typeof(SDKTemplate.BillingScenario.Payment_Mode.PaymentByCash));
            else if (PayLaterRadBtn.IsChecked == true)
                this.Frame.Navigate(typeof(SDKTemplate.BillingScenario.Payment_Mode.PayLater));
            else if (DebitRadBtn.IsChecked == true)
