...
namespace SDKTemplate
{
    public class OTPVConstants
    {
        ...
        public static readonly string PayToSupplier_Transaction = "OTP for Paying INR {0} Now to Supplier {0} is {2}. Please donot share it with anyone for security reasons.";
