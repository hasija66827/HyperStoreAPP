    ...
    public sealed partial class PayLaterCC : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (this.PageNavigationParameter.OrderType == OrderType.SupplierOrder)
            {
                ...
                _CV.PaymentOption = this.PageNavigationParameter.SupplierPageNavigationParameter.CheckoutViewModel?.PaymentOption;
            }
            else
            {
                _CV.AmountToBePaid = this.PageNavigationParameter.CustomerPageNavigationParameter.BillingSummaryViewModel.BillAmount;
                _CV.PaymentOption = this.PageNavigationParameter.CustomerPageNavigationParameter.CheckoutViewModel?.PaymentOption;
            }
        }
